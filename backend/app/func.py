...
# @func.route('/api/newsStocks',methods=['POST'])
# def news_stock():
#     # insert_news()
#     req = request.json
...
# @func.route('/api/Market', methods=['POST'])
# def market_page():
...
# @func.route('/api/indexStocks', methods=['POST'])
# def index_stocks():
#     req        = request.get_json()
...
# @func.route('/api/StrategyStock', methods=['POST'])
# def strategy_stock():
...
# @func.route('/api/StockInformation', methods=['POST'])
...
# @func.route('/db/GetAndInsertNews')
# def get_news():
...
# @func.route('/db/GetAndInsertStocks')
# def get_stocks():
...
# @func.route('/db/GetAndInsertFigures')
# def get_figures():
...
# @func.route('/db/GetAndInsertIndicators')
# def get_indicators():
